...
metadata:
  ...
  source: maintainer
  tags: "mistral,mistralai,llm,chat,embeddings,ocr,agents,response,environ,upload,choices,stream,create,files,process,vectors,complete,Version-Sensitive,model_dump,pages,rename"
---
