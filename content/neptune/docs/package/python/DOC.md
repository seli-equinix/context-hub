...
| `sync` | Method | Synchronizes the local representation of the object with the representation on… |
| `wait` | Method | Wait for all the queued metadata tracking calls to reach the Neptune servers.… |
| `Project` | Class | Starts a connection to an existing Neptune project.  You can use the Project ob… |
| `assign` | Method | Assigns values to multiple fields from a dictionary.  You can use this method t… |
| `define` | Method |  |
| `exists` | Method | Checks if there is a field or namespace under the specified path. |
| `fetch` | Method | Fetch values of all non-File Atom fields as a dictionary.  You can use this met… |
| `fetch_models_table` | Method | Retrieve models stored in the project.  Args:     query: NQL query string. Synt… |
| `fetch_runs_table` | Method | Retrieve runs matching the specified criteria.  All parameters are optional. Ea… |
| `get_attribute` | Method |  |
| `get_root_object` | Method | Returns the same Neptune object. |
| `get_state` | Method | Returns the current state of the container as a string.  Examples:     >>> from… |
| `get_structure` | Method | Returns the object's metadata structure as a dictionary.  This method can be us… |
...
| `sync` | Method | Synchronizes the local representation of the object with the representation on… |
| `wait` | Method | Wait for all the queued metadata tracking calls to reach the Neptune servers.… |
| `Run` | Class | Starts a new tracked run that logs ML model-building metadata to neptune.ai.  Y… |
| `assign` | Method | Assigns values to multiple fields from a dictionary.  You can use this method t… |
| `define` | Method |  |
| `exists` | Method | Checks if there is a field or namespace under the specified path. |
| `fetch` | Method | Fetch values of all non-File Atom fields as a dictionary.  You can use this met… |
...
| `init_model` | Class | Initializes a Model object from an existing or new model.  You can use this to… |
| `assign` | Method | Assigns values to multiple fields from a dictionary.  You can use this method t… |
| `define` | Method |  |
| `exists` | Method | Checks if there is a field or namespace under the specified path. |
| `fetch` | Method | Fetch values of all non-File Atom fields as a dictionary.  You can use this met… |
...
| `sync` | Method | Synchronizes the local representation of the object with the representation on… |
| `wait` | Method | Wait for all the queued metadata tracking calls to reach the Neptune servers.… |
| `init_model_version` | Class | Initializes a ModelVersion object from an existing or new model version.  Befor… |
| `assign` | Method | Assigns values to multiple fields from a dictionary.  You can use this method t… |
| `change_stage` | Method | Changes the stage of the model version.  This method is always synchronous, whi… |
| `define` | Method |  |
| `exists` | Method | Checks if there is a field or namespace under the specified path. |
...
| `sync` | Method | Synchronizes the local representation of the object with the representation on… |
| `wait` | Method | Wait for all the queued metadata tracking calls to reach the Neptune servers.… |
| `init_project` | Class | Starts a connection to an existing Neptune project.  You can use the Project ob… |
| `assign` | Method | Assigns values to multiple fields from a dictionary.  You can use this method t… |
| `define` | Method |  |
| `exists` | Method | Checks if there is a field or namespace under the specified path. |
| `fetch` | Method | Fetch values of all non-File Atom fields as a dictionary.  You can use this met… |
...
| `sync` | Method | Synchronizes the local representation of the object with the representation on… |
| `wait` | Method | Wait for all the queued metadata tracking calls to reach the Neptune servers.… |
| `init_run` | Class | Starts a new tracked run that logs ML model-building metadata to neptune.ai.  Y… |
| `assign` | Method | Assigns values to multiple fields from a dictionary.  You can use this method t… |
| `define` | Method |  |
| `exists` | Method | Checks if there is a field or namespace under the specified path. |
| `fetch` | Method | Fetch values of all non-File Atom fields as a dictionary.  You can use this met… |
...
| `FileEntry` | Class | FileEntry(name: str, size: int, mtime: datetime.datetime, file_type: str) |
| `from_dto` | Method |  |
| `ensure_json_response` | Function |  |
| `AttributeType` | Class | Create a collection of name/value pairs.  Example enumeration:  >>> class Color… |
| `AttributeWithProperties` | Class | AttributeWithProperties(path: str, type: neptune.internal.backends.api_model.At… |
| `LeaderboardEntry` | Class | LeaderboardEntry(id: str, attributes: List[neptune.internal.backends.api_model.… |
| `NQLAggregator` | Class | str(object='') -> str str(bytes_or_buffer[, encoding[, errors]]) -> str  Create… |
| `NQLAttributeOperator` | Class | str(object='') -> str str(bytes_or_buffer[, encoding[, errors]]) -> str  Create… |
| `NQLAttributeType` | Class | str(object='') -> str str(bytes_or_buffer[, encoding[, errors]]) -> str  Create… |
| `NQLEmptyQuery` | Class | NQLEmptyQuery() |
| `eval` | Method |  |
| `NQLQuery` | Class | NQLQuery() |
| `eval` | Method |  |
| `NQLQueryAggregate` | Class | NQLQueryAggregate(items: 'Iterable[NQLQuery]', aggregator: 'NQLAggregator') |
| `eval` | Method |  |
| `NQLQueryAttribute` | Class | NQLQueryAttribute(name: 'str', type: 'NQLAttributeType', operator: 'NQLAttribut… |
| `eval` | Method |  |
| `NeptuneInvalidQueryException` | Class | Common base class for all non-exit exceptions. |
| `NoLimit` | Class | int([x]) -> integer int(x, base=10) -> integer  Convert a number or string to a… |
| `construct_progress_bar` | Function |  |
| `find_attribute` | Function |  |
| `get_single_page` | Function |  |
| `iter_over_pages` | Function |  |
| `to_leaderboard_entry` | Function |  |
| `Artifact` | Class |  |
| `assign` | Method |  |
| `copy` | Method |  |
| `download` | Method |  |
| `fetch` | Method |  |
| `fetch_files_list` | Method |  |
| `fetch_hash` | Method |  |
| `process_assignment` | Method |  |
| `track_files` | Method |  |
| `Boolean` | Class |  |
| `assign` | Method |  |
| `copy` | Method |  |
| `create_assignment_operation` | Method |  |
| `fetch` | Method |  |
