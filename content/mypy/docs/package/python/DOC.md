...
| `UnpackType` | Class |  |
| `get_proper_type` | Function |  |
| `map_actuals_to_formals` | Function |  |
| `map_formals_to_actuals` | Function |  |
| `map_instance_to_supertype` | Function |  |
| `AnyType` | Class |  |
| `ConditionalTypeBinder` | Class |  |
| `accumulate_type_assignments` | Method |  |
| `top_frame_context` | Method |  |
| `CurrentType` | Class | mypyc filler docstring |
| `Expression` | Class |  |
| `Frame` | Class |  |
| `FrameContext` | Class |  |
| `IndexExpr` | Class |  |
...
| `UnpackType` | Class |  |
| `Var` | Class |  |
| `collapse_variadic_union` | Function |  |
| `extract_var_from_literal_hash` | Function |  |
| `fill_typevars_with_any` | Function |  |
| `find_unpack_in_list` | Function |  |
| `flatten_nested_unions` | Function |  |
| `get_declaration` | Function |  |
| `get_proper_type` | Function |  |
| `is_same_type` | Function |  |
| `is_subtype` | Function |  |
| `literal` | Function |  |
| `literal_hash` | Function |  |
| `make_simplified_union` | Function |  |
| `remove_instance_last_known_values` | Function |  |
| `subkeys` | Function |  |
| `AckMessage` | Class |  |
| `BadStatus` | Class |  |
| `BuildManager` | Class |  |
...
| `Errors` | Class |  |
| `Expression` | Class |  |
| `FgDepMeta` | Class | mypyc filler docstring |
| `FileRawData` | Class |  |
| `FileSystemCache` | Class |  |
| `FilesystemMetadataStore` | Class |  |
| `FindModuleCache` | Class |  |
| `GraphMessage` | Class |  |
| `IPCClient` | Class |  |
| `IPCException` | Class |  |
| `IPCMessage` | Class |  |
...
| `ImportBase` | Class |  |
| `ImportFrom` | Class |  |
| `LimitedVariableRenameVisitor` | Class |  |
| `enter_scope` | Method |  |
| `MessageBuilder` | Class |  |
| `disable_type_names` | Method |  |
| `MetadataStore` | Class |  |
| `ModuleNotFound` | Class | Common base class for all non-exit exceptions. |
| `ModuleNotFoundReason` | Class | mypyc filler docstring |
| `MypyFile` | Class |  |
| `NodeInfo` | Class |  |
| `Options` | Class |  |
| `Plugin` | Class |  |
| `PossiblyUndefinedVariableVisitor` | Class |  |
| `ReportConfigContext` | Class | mypyc filler docstring |
| `SCC` | Class |  |
| `SccRequestMessage` | Class |  |
| `SccResponseMessage` | Class |  |
| `SccsDataMessage` | Class |  |
| `SearchPaths` | Class |  |
| `SemanticAnalyzer` | Class |  |
| `allow_unbound_tvars_set` | Method |  |
| `enter` | Method |  |
| `file_context` | Method |  |
| `inside_except_star_block_set` | Method |  |
| `isolated_error_analysis` | Method |  |
| `overload_item_set` | Method |  |
| `set_recurse_into_functions` | Method |  |
| `tvar_scope_frame` | Method |  |
| `SemanticAnalyzerPreAnalysis` | Class |  |
| `SourcesDataMessage` | Class |  |
...
| `Type` | Class |  |
| `TypeChecker` | Class |  |
| `checking_await_set` | Method |  |
| `enter_attribute_inference_context` | Method |  |
| `enter_class` | Method |  |
| `enter_final_context` | Method |  |
| `enter_overload_impl` | Method |  |
| `enter_partial_types` | Method |  |
| `set_recurse_into_functions` | Method |  |
| `TypeIndirectionVisitor` | Class |  |
| `VariableRenameVisitor` | Class |  |
| `enter_block` | Method |  |
| `enter_loop` | Method |  |
| `enter_scope` | Method |  |
| `enter_try` | Method |  |
| `WorkerClient` | Class |  |
| `add_catch_all_gitignore` | Function |  |
| `build` | Function |  |
| `build_error` | Function |  |
| `build_inner` | Function |  |
| `compute_hash` | Function |  |
| `compute_search_paths` | Function |  |
| `create_metastore` | Function |  |
| `decode_python_encoding` | Function |  |
| `default_data_dir` | Function |  |
| `deps_filtered` | Function |  |
| `deps_to_json` | Function |  |
| `dispatch` | Function |  |
| `dump_graph` | Function |  |
| `dump_line_checking_stats` | Function |  |
| `dump_timing_stats` | Function |  |
| `dump_type_stats` | Function |  |
| `exclude_from_backups` | Function |  |
| `exist_added_packages` | Function |  |
| `exist_removed_submodules` | Function |  |
| `find_cache_meta` | Function |  |
| `find_config_file_line_number` | Function |  |
| `find_module_and_diagnose` | Function |  |
| `find_module_simple` | Function |  |
| `find_module_with_reason` | Function |  |
| `find_stale_sccs` | Function |  |
| `fixup_module` | Function |  |
| `free_tree` | Function |  |
| `generate_deps_for_cache` | Function |  |
| `get_cache_names` | Function |  |
| `get_config_module_names` | Function |  |
| `get_errors_name` | Function |  |
| `get_mypy_comments` | Function |  |
| `hash_digest` | Function |  |
| `hash_digest_bytes` | Function |  |
| `import_priority` | Function |  |
| `in_partial_package` | Function |  |
