...
metadata:
  ...
  source: maintainer
  tags: "webpack,webpack-bundle-analyzer,bundle-analysis,performance,build,javascript,path,plugins,resolve,5.2.0,push,bundler,build-tool,Configuration,Compiler,Compilation,Stats,Module,Chunk,ChunkGroup,Asset,watch,run,close"
---
...
`webpack-bundle-analyzer` is consumed by webpack's runtime as a plugin, loader, or config helper. The types below are webpack's stable plugin/loader API.
