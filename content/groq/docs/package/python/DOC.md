...
metadata:
  ...
  source: maintainer
  tags: "groq,llm,inference,chat,streaming,audio,completions,create,AsyncGroq,choices,APIConnectionError,APIStatusError,Path,asyncio,environ,main,transcriptions,translations,Version-Sensitive,run"
---
