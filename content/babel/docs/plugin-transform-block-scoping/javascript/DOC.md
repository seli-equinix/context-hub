...
metadata:
  ...
  source: maintainer
  tags: "babel,build,javascript,transpile,let,const,console,log,callbacks,push,babel-core,babel-types,babel-traverse,babel-template,babel-generator,babel-plugin,default,@babel/core,transformSync,parseSync,traverse,template,File,Plugin,OptionManager"
---
...
## API surface — verifiable exports of `@babel/plugin-transform-block-scoping`

Each symbol below is a real export of `@babel/plugin-transform-block-scoping`, verified via `Object.keys(require('@babel/plugin-transform-block-scoping'))`.
...
const r_buildExternalHelpers = babel.buildExternalHelpers(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_createConfigItem = babel.createConfigItem(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_createConfigItemAsync = babel.createConfigItemAsync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_createConfigItemSync = babel.createConfigItemSync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_getEnv = babel.getEnv(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_loadOptions = babel.loadOptions(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_loadOptionsAsync = babel.loadOptionsAsync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_loadOptionsSync = babel.loadOptionsSync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_loadPartialConfig = babel.loadPartialConfig(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_loadPartialConfigAsync = babel.loadPartialConfigAsync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_loadPartialConfigSync = babel.loadPartialConfigSync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_parse = babel.parse(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_parseAsync = babel.parseAsync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_parseSync = babel.parseSync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_resolvePlugin = babel.resolvePlugin(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_resolvePreset = babel.resolvePreset(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_template = babel.template(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transform = babel.transform(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transformAsync = babel.transformAsync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transformFile = babel.transformFile(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transformFileAsync = babel.transformFileAsync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transformFileSync = babel.transformFileSync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transformFromAst = babel.transformFromAst(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transformFromAstAsync = babel.transformFromAstAsync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transformFromAstSync = babel.transformFromAstSync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_transformSync = babel.transformSync(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
const r_traverse = babel.traverse(code, { plugins: ['@babel/plugin-transform-block-scoping'] });
```
