...
| `to_json` | Method | Given a message instance, serialize it to json  Args:     instance: An instance… |
| `wrap` | Method | Return a Message object that shallowly wraps the descriptor.  Args:     pb: A p… |
| `ExtendedSourceContext` | Class | An ExtendedSourceContext is a SourceContext combined with additional details de… |
| `copy_from` | Method | Equivalent for protobuf.Message.CopyFrom  Args:     instance: An instance of th… |
| `deserialize` | Method | Given a serialized proto, deserialize it into a Message instance.  Args:     pa… |
| `from_json` | Method | Given a json string representing an instance, parse it into a message.  Args:… |
| `pb` | Method | Return the underlying protobuf Message class or instance.  Args:     obj: If pr… |
...
| `to_json` | Method | Given a message instance, serialize it to json  Args:     instance: An instance… |
| `wrap` | Method | Return a Message object that shallowly wraps the descriptor.  Args:     pb: A p… |
| `GerritSourceContext` | Class | A SourceContext referring to a Gerrit project.  This message has `oneof`_ field… |
| `copy_from` | Method | Equivalent for protobuf.Message.CopyFrom  Args:     instance: An instance of th… |
| `deserialize` | Method | Given a serialized proto, deserialize it into a Message instance.  Args:     pa… |
| `from_json` | Method | Given a json string representing an instance, parse it into a message.  Args:… |
| `pb` | Method | Return the underlying protobuf Message class or instance.  Args:     obj: If pr… |
...
| `to_json` | Method | Given a message instance, serialize it to json  Args:     instance: An instance… |
| `wrap` | Method | Return a Message object that shallowly wraps the descriptor.  Args:     pb: A p… |
| `GitSourceContext` | Class | A GitSourceContext denotes a particular revision in a third party Git repositor… |
| `copy_from` | Method | Equivalent for protobuf.Message.CopyFrom  Args:     instance: An instance of th… |
| `deserialize` | Method | Given a serialized proto, deserialize it into a Message instance.  Args:     pa… |
| `from_json` | Method | Given a json string representing an instance, parse it into a message.  Args:… |
| `pb` | Method | Return the underlying protobuf Message class or instance.  Args:     obj: If pr… |
...
| `to_json` | Method | Given a message instance, serialize it to json  Args:     instance: An instance… |
| `wrap` | Method | Return a Message object that shallowly wraps the descriptor.  Args:     pb: A p… |
| `ProjectRepoId` | Class | Selects a repo using a Google Cloud Platform project ID (e.g. winged-cargo-31)… |
| `copy_from` | Method | Equivalent for protobuf.Message.CopyFrom  Args:     instance: An instance of th… |
| `deserialize` | Method | Given a serialized proto, deserialize it into a Message instance.  Args:     pa… |
| `from_json` | Method | Given a json string representing an instance, parse it into a message.  Args:… |
| `pb` | Method | Return the underlying protobuf Message class or instance.  Args:     obj: If pr… |
...
| `to_json` | Method | Given a message instance, serialize it to json  Args:     instance: An instance… |
| `wrap` | Method | Return a Message object that shallowly wraps the descriptor.  Args:     pb: A p… |
| `RepoId` | Class | A unique identifier for a cloud repo.  This message has `oneof`_ fields (mutual… |
| `copy_from` | Method | Equivalent for protobuf.Message.CopyFrom  Args:     instance: An instance of th… |
| `deserialize` | Method | Given a serialized proto, deserialize it into a Message instance.  Args:     pa… |
| `from_json` | Method | Given a json string representing an instance, parse it into a message.  Args:… |
| `pb` | Method | Return the underlying protobuf Message class or instance.  Args:     obj: If pr… |
...
| `to_json` | Method | Given a message instance, serialize it to json  Args:     instance: An instance… |
| `wrap` | Method | Return a Message object that shallowly wraps the descriptor.  Args:     pb: A p… |
| `SourceContext` | Class | A SourceContext is a reference to a tree of files. A SourceContext together wit… |
| `copy_from` | Method | Equivalent for protobuf.Message.CopyFrom  Args:     instance: An instance of th… |
| `deserialize` | Method | Given a serialized proto, deserialize it into a Message instance.  Args:     pa… |
| `from_json` | Method | Given a json string representing an instance, parse it into a message.  Args:… |
| `pb` | Method | Return the underlying protobuf Message class or instance.  Args:     obj: If pr… |
